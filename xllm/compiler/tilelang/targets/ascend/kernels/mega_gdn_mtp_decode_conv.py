...
"""AOT family for the channel-tile-owned MegaGdnMtpDecode Conv stage."""
...
@register_kernel
class MegaGdnMtpDecodeConvKernel(TilelangKernel):
    TARGET = "pto"
    KERNEL_NAME = "mega_gdn_mtp_decode_conv"
    ...
    def generate_source(
        ...
        _, source = lower_mega_gdn_mtp_conv_pto(
