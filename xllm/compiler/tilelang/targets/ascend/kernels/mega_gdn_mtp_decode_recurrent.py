...
"""AOT family for the value-head-half-owned MTP recurrent stage."""
...
from .mega_gdn_mtp_decode_segmented import (
    ...
    lower_mega_gdn_mtp_recurrent_pto,
)


@register_kernel
class MegaGdnMtpDecodeRecurrentKernel(TilelangKernel):
    TARGET = "pto"
    ...
    def generate_source(
        ...
        _, source = lower_mega_gdn_mtp_recurrent_pto(
